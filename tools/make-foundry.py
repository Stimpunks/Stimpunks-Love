...
<!-- og:image:alt, below, is make-og.py's line: it builds the card and writes the alt to
     ...
     THIS COMMENT SITS ABOVE og:url, NOT BESIDE THE ALT: make-og.py writes the
     card's tags straight after og:url, so anywhere else and the two tools
     reorder this head every time either runs. -->
