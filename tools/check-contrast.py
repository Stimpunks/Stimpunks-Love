...
PAIRS = [
    ...
    (EMBER2,  CANVAS,  False, "yurt: a pebble's name in the wicker basket"),
    (TALLOW,  TENT,    False, "yurt: the soundtrack deck's label"),
    (CANDLE,  TENT,    False, "yurt: the deck's PRESS PLAY"),
    (TALLOW,  CANVAS,  False, "yurt: the deck's label on hover"),
    (CANDLE,  CANVAS,  False, "yurt: the deck's PRESS PLAY on hover"),
